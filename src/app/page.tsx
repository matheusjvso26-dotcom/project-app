...
export default function Home() {
  return (
    <div className="min-h-screen bg-[#000000] text-foreground font-sans selection:bg-[#ff7b00]/30 selection:text-white pb-0 overflow-hidden">

      {/* --- HEADER --- */}
      <header className="fixed top-0 left-0 w-full z-50 border-b border-border/50 bg-black/50 backdrop-blur-md pt-4 pb-4">
      ...
      <main className="pt-28">
        ...
        <section className="relative pt-20 pb-24 px-6 flex flex-col items-center text-center z-10">
          ...
          <div className="w-full max-w-[1000px] h-[300px] sm:h-[450px] relative rounded-t-xl border-t border-x border-border bg-[#0c0c0c] shadow-[0_-20px_50px_rgba(0,0,0,0.8)] overflow-hidden flex flex-col mx-auto">
            <div className="h-10 border-b border-border bg-muted flex items-center px-4 gap-2 shrink-0">
        ...
        <section id="vantagens" className="py-24 px-6 bg-[#050505] border-t border-border/50">
        ...
        <section id="solucoes" className="py-24 px-6 relative">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-background rounded-full pointer-events-none -z-10"></div>
          ...
          <div className="max-w-[1200px] mx-auto flex flex-col gap-10">
            ...
            <div className="flex flex-col md:flex-row items-center gap-10 bg-[#0a0a0a] border border-[#222] p-8 md:p-12 rounded-2xl hover:border-[#ff7b00]/30 transition-colors">
              ...
              <div className="md:w-1/2 w-full flex justify-center">
                <div className="w-full aspect-video bg-background border border-border rounded-xl flex items-center justify-center p-6 shadow-2xl relative overflow-hidden">
        ...
        <footer className="py-16 bg-[#000000] border-t border-[#111]">
          ...
          <div className="max-w-[1200px] mx-auto px-6 mt-16 text-center text-xs text-muted-foreground font-medium tracking-widest uppercase">
